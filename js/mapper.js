        ...
        x.forEach(element => {
            ...
            rules.forEach(element1 => {
                ...
                if(typeof element1[2]!== "undefined"){
                    array[i].set(k[1],element1[2](array[i][k[1]]))
...
console.log(mapper(testData3,mapRules)) // [{"n":"vasya","a":20},{"n":"dima","a":34},{"n":"colya","a":46},{"n":"misha","a":16},{"n":"ashan","a":99},{"n":"rafshan","a":11}]
